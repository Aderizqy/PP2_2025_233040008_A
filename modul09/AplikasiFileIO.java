...
public class AplikasiFileIO extends JFrame {
    ...
    public AplikasiFileIO() {
        ...
        // 2.MENULIS FILE TEKS (Teks Stream)
    ...
    // Metode untuk membaca file last_notes.txt secara otomatis
    private void bacaLastNotes() {
        ...
        try {
            ...
            if (file.exists()) {
                ...
                // Tidak perlu menampilkan pesan, aplikasi hanya diam saja
                System.out.println("File last_notes.txt berhasil dimuat secara otomatis");
            }
        } catch (IOException ex) {
            // File tidak ada atau error lainnya, aplikasi tetap berjalan tanpa error
            System.out.println("File last_notes.txt tidak ditemukan atau error: " + ex.getMessage());
        } finally {
            // Menutup stream jika terbuka
            try {
                if (reader != null) {
                    reader.close();
                }
    ...
    // Contoh: Membaca File Teks dengan Try-Catch-Finally Konvesional
